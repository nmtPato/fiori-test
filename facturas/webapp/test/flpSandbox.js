		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "FacturasApp",
									"targetURL": "#facturasAppfacturas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"facturasAppfacturas-display": {
								"semanticObject": "facturasAppfacturas",
								"action": "display",
								"description": "A Fiori application prueba",
								"title": "FacturasApp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=facturasApp.facturas",
									"url": sap.ui.require.toUrl("facturasApp/facturas")
								}
							}
						}
					}
